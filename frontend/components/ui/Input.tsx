  ...
  ({ label, error, helperText, className = "", ...props }, ref) => {
    return (
      <div className="w-full">
        ...
        <input
          ref={ref}
          className={`block w-full px-4 h-11 border rounded-xl shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 placeholder:text-slate-400 text-slate-900 text-base sm:text-sm ${
            error
